        ...
        <Card className="mb-3 border-0">
          <CardBody>
            <Form>
              ...
              <FormGroup>
                <Label for="minRating">
                  Filter by rating: ({filters?.minRating ? filters.minRating : 0} and above)
                </Label>
                <Input
                  type="range"
                  name="minRating"
              ...
              <FormGroup>
                <Label for="minReviewCount">
                  Filter by number of reviews: ({filters?.minReviewCount ? filters.minReviewCount : 0} and
                  above)
                </Label>
                <Input
                  type="range"
              ...
              <FormGroup>
                <Label for="minCommentCount">
                  Filter by number of comments: ({filters?.minCommentCount ? filters.minCommentCount : 0} and above)
                </Label>
                <Input
                  type="range"

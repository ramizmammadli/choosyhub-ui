          ...
          <Col className="d-flex flex-column justify-content-between my-2">
            <Row>
              <Col>
                ...
                <h5>
                  <FontAwesomeIcon icon={faStar} className="text-warning" /> {product.rating.toFixed(1)} Stars{" "}
                  <small>({product.number_of_reviews} Reviews)</small>
                </h5>
                <h5>
                  <FontAwesomeIcon icon={faComment} className="text-info" /> {product.number_of_comments} Comments
                </h5>
              </Col>
            </Row>
